...
///
/// [submit] returns true on success. Navigation is handled by
/// [NavigationNotifier.onLoginSuccess] rather than context.pop, since
/// Navigator 2 state is driven by Riverpod not BuildContext.
