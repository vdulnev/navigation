...
///
/// * **Per-tab navigation**: `context.router.push(ItemDetailRoute(...))` pushes
///   within the search tab's [StackRouter], keeping the search tab active.
@RoutePage()
          ...
          const Padding(
            ...
            child: NavNoteCard(
              ...
              body:
                  ...
                  'changes. context.router.push stays within the search '
                  "tab's StackRouter — back-stack is preserved.",
            ),
          ),
        ],
      ),
    ...
    return ListView.builder(
      ...
      itemBuilder: (context, index) {
        ...
        return ListTile(
          ...
          onTap: () => context.router.push(ItemDetailRoute(product: product)),
        );
      },
    );
  }
