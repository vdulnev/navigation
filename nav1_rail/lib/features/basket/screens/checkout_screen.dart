...
///
/// • **No [NavigationRail]** — detail screens within a section do not expose
///   the rail. The user navigates back via the AppBar.
///
      ...
      body: ListView(
        ...
        children: [
          ...
          const NavNoteCard(
            ...
            body:
                'Checkout is pushed on the Basket section\'s Navigator via '
                'pushNamed. pop() returns to BasketScreen. The rail shell '
                'stays mounted — other sections keep their state.',
          ),
        ],
      ),
    );
