...
/// Account section — shows a sign-in prompt or the user's profile depending
/// on authentication state.
///
/// Navigator 1 concepts demonstrated:
///
/// • **rootNavigator: true** — the Sign In button pushes `/login` above the
///   entire rail scaffold by targeting the MaterialApp's root Navigator.
///
        ...
        children: [
          ...
          const NavNoteCard(
            ...
            body:
                ...
                'MaterialApp\'s Navigator — it slides over the entire rail '
