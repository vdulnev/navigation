...
/// Login screen presented as a fullscreen dialog over the rail shell.
///
/// Navigator 1 concepts demonstrated:
///
/// • Pushed via `rootNavigator: true` from any section — sits on top of the
///   entire [ShellScreen] including all per-section Navigators.
///
